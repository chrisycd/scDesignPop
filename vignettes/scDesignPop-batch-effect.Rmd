...
Here we use a Negative Binominal as the parametric model using `"nb"`. Since we want to include the batch effect modeling, we specify `mean_formula = "(1|indiv) + cell_type + pool`. Here, we use pseudo-batches to show how scDesignPop can model and alter the batch effects.
