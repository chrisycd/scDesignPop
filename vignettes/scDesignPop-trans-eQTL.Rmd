...
## Load data prepare the eQTL genotype dataframe as input
...
```{r}
res_list <- createPbulkExprGeno(sce_list = list("Simulated" = simu_sce),
                                eqtlgeno = trans_eqtlgeno,
                                feature_sel = "ENSG00000121064",
                                celltype_sel = "bmem",
                                eqtl_snp = "2:182323766",
